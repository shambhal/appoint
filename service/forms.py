...
class SServiceForm(forms.ModelForm):
    ...
    sdate=forms.DateField(label="Special Date",widget=forms.widgets.TextInput(attrs={'class':'form-control datepicker','id':'sdate'})  )  
...
class BookEditForm(forms.ModelForm):
   class Meta: 
    model=Book
    #fields = "__all__"
    fields=["phone","name","status","dated","slot","email"]
